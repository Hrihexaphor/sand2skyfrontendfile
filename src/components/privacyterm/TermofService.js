...
const TermofService = () => {
   ...
   const [termsOfService, setTermsOfService] = useState([]);
    ...
    useEffect(() => {
      axios
        .get(`${process.env.REACT_APP_BASE_URL}/termsandservice`, {
        ...
        <div className="mb-4 ps-0">
          <div className="relative w-full h-[200px] md:h-[300px] overflow-hidden">
            ...
            <div className="absolute mt-5 inset-0 flex flex-col items-center justify-center text-white">
              <h2 className="text-3xl font-bold font-geometric-regular">Term of Service</h2>
              <p className="mt-2 text-sm">
                <Link to="/" className="no-underline text-white font-semibold">Home</Link>
                <span className="mx-1">/</span>
                <span className="text-yellow-400 font-semibold">Term of Service</span>
              </p>
            </div>
          </div>
        </div>
